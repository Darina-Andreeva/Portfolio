<div class='load-container' data-url="<?php echo get_permalink($post->ID); ?>" data-page="2" data-filter="<?php $_GET['post']; ?>"  data-page-slug='news'>
    ...
    <div class="post-load-more">
        <?php if (get_load_more_type() == 'button') { ?>
            <a class='load-button'><?php echo get_post_button(); ?>
                <div class="inner">
                    <div class="load-container load1">
                        <div class="loader">Loading...</div>
                    </div>
